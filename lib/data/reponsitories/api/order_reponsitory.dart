...
import 'package:carx/utils/notification/notification_service.dart';
import 'package:dio/dio.dart';

class OrderReponsitory {
  final Dio _dio;

  const OrderReponsitory(this._dio);
  factory OrderReponsitory.response() =>
      OrderReponsitory(DioClient.instance.dio);
